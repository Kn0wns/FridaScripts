/*
    Android SSL 证书固定绕过脚本的各种方法

	Run with:
	frida -U -f [APP_ID] -l frida_multiple_unpinning.js --no-pause
 */
export const multi_unpinning = () => {
    Java.perform(function () {
        ...
        try {
            // Bypass OkHTTPv3 {1}
            let okhttp3_Activity_1 = Java.use('okhttp3.CertificatePinner');
        ...
        try {
            ...
            let okhttp3_Activity_2 = Java.use('okhttp3.CertificatePinner');
        ...
        try {
            // Bypass OkHTTPv3 {3}
            let okhttp3_Activity_3 = Java.use('okhttp3.CertificatePinner');
        ...
        try {
            // Bypass OkHTTPv3 {4}
            let okhttp3_Activity_4 = Java.use('okhttp3.CertificatePinner');
        ...
        try {
            // Bypass Trustkit {1}
            let trustkit_Activity_1 = Java.use('com.datatheorem.android.trustkit.pinning.OkHostnameVerifier');
        ...
        try {
            // Bypass Trustkit {2}
            let trustkit_Activity_2 = Java.use('com.datatheorem.android.trustkit.pinning.OkHostnameVerifier');
        ...
        ///////////////////////////////////////
        try {
            let OpenSSLEngineSocketImpl_Activity = Java.use('com.android.org.conscrypt.OpenSSLEngineSocketImpl');
        ...
        //////////////////////////////////////
        try {
            let OpenSSLSocketImpl_Harmony = Java.use('org.apache.harmony.xnet.provider.jsse.OpenSSLSocketImpl');
        ...
        try {
            ...
            let WLClient_Activity_1 = Java.use('com.worklight.wlclient.api.WLClient');
        ...
        try {
            ...
            let WLClient_Activity_2 = Java.use('com.worklight.wlclient.api.WLClient');
        ...
        try {
            ...
            let worklight_Activity_1 = Java.use('com.worklight.wlclient.certificatepinning.HostNameVerifierWithCertificatePinning');
        ...
        try {
            ...
            let worklight_Activity_2 = Java.use('com.worklight.wlclient.certificatepinning.HostNameVerifierWithCertificatePinning');
        ...
        try {
            ...
            let worklight_Activity_3 = Java.use('com.worklight.wlclient.certificatepinning.HostNameVerifierWithCertificatePinning');
        ...
        try {
            ...
            let worklight_Activity_4 = Java.use('com.worklight.wlclient.certificatepinning.HostNameVerifierWithCertificatePinning');
        ...
        //////////////////////////////
        try {
            let conscrypt_CertPinManager_Activity = Java.use('com.android.org.conscrypt.CertPinManager');
        ...
        ///////////////////////////////////////////////////////////////////////////////////
        try {
            let cwac_CertPinManager_Activity = Java.use('com.commonsware.cwac.netsecurity.conscrypt.CertPinManager');
        ...
        /////////////////////////////////////////////////////
        try {
            let androidgap_WLCertificatePinningPlugin_Activity = Java.use('com.worklight.androidgap.plugin.WLCertificatePinningPlugin');
        ...
        //////////////////////////////////////////
        try {
            let netty_FingerprintTrustManagerFactory = Java.use('io.netty.handler.ssl.util.FingerprintTrustManagerFactory');
            //NOTE: sometimes this below implementation could be useful
            //let netty_FingerprintTrustManagerFactory = Java.use('org.jboss.netty.handler.ssl.util.FingerprintTrustManagerFactory');
        ...
        try {
            ...
            let Squareup_CertificatePinner_Activity_1 = Java.use('com.squareup.okhttp.CertificatePinner');
        ...
        try {
            ...
            let Squareup_CertificatePinner_Activity_2 = Java.use('com.squareup.okhttp.CertificatePinner');
        ...
        try {
            ...
            let Squareup_OkHostnameVerifier_Activity_1 = Java.use('com.squareup.okhttp.internal.tls.OkHostnameVerifier');
        ...
        try {
            ...
            let Squareup_OkHostnameVerifier_Activity_2 = Java.use('com.squareup.okhttp.internal.tls.OkHostnameVerifier');
        ...
        try {
            ...
            let AndroidWebViewClient_Activity_1 = Java.use('android.webkit.WebViewClient');
        ...
        try {
            ...
            let AndroidWebViewClient_Activity_2 = Java.use('android.webkit.WebViewClient');
        ...
        //////////////////////////////////
        try {
            let CordovaWebViewClient_Activity = Java.use('org.apache.cordova.CordovaWebViewClient');
        ...
        ///////////////////////////
        try {
            let boye_AbstractVerifier = Java.use('ch.boye.httpclientandroidlib.conn.ssl.AbstractVerifier');
